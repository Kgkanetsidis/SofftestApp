...
@NgModule({
  declarations: [DashboardComponent, CategoryComponent, CategoryAddComponent, CategoryListComponent, ProductAddComponent, ProductListComponent, AdminProductComponent, AdminOrderComponent, AdminOrderListComponent, OrderUpdateComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
